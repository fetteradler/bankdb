...
CREATE TABLE IF NOT EXISTS Sparbuch (sparId INTEGER UNSIGNED AUTO_INCREMENT NOT NULL PRIMARY KEY, guthaben INTEGER UNSIGNED NOT NULL, zinsen SMALLINT)
...
CREATE TABLE IF NOT EXISTS Kreditkartenkonto (kreditkarteId INTEGER UNSIGNED AUTO_INCREMENT NOT NULL PRIMARY KEY, betrag INTEGER UNSIGNED NOT NULL, zinsen SMALLINT)

CREATE TABLE IF NOT EXISTS Kredit (kreditId INTEGER UNSIGNED AUTO_INCREMENT NOT NULL PRIMARY KEY, betrag INTEGER NOT NULL, zinsen SMALLINT, raten INTEGER, laufzeit DATE)
