...
CREATE TABLE IF NOT EXISTS Sparbuch (sparId INTEGER UNSIGNED AUTO_INCREMENT NOT NULL PRIMARY KEY, eroefnung DATE NOT NULL, schliessung DATE, guthaben INTEGER UNSIGNED NOT NULL, zinsen SMALLINT)

CREATE TABLE IF NOT EXISTS Girokonto (giroId INTEGER UNSIGNED AUTO_INCREMENT NOT NULL PRIMARY KEY, eroefnung DATE NOT NULL, schliessung DATE, guthaben INTEGER NOT NULL, gebueren INTEGER)

CREATE TABLE IF NOT EXISTS Kreditkartenkonto (kreditkarteId INTEGER UNSIGNED AUTO_INCREMENT NOT NULL PRIMARY KEY, eroefnung DATE NOT NULL, schliessung DATE, betrag INTEGER UNSIGNED NOT NULL, zinsen SMALLINT)

CREATE TABLE IF NOT EXISTS Kredit (kreditId INTEGER UNSIGNED AUTO_INCREMENT NOT NULL PRIMARY KEY, betrag INTEGER NOT NULL, zinsen SMALLINT, erstellDatum DATE, raten INTEGER, laufzeit DATE)
